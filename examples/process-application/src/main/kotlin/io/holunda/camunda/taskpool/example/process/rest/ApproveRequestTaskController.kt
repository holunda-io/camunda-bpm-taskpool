...
class ApproveRequestTaskController(
  ...
  override fun loadTaskApproveRequestFormData(
    ...
    return ResponseEntity.ok(TaskApproveRequestFormDataDto().approvalRequest(approvalRequest).task(task))
  }
  ...
  override fun submitTaskApproveRequestSubmitData(
    ...
    processApproveRequestBean.approveTask(id, payload.approvalDecision, payload.comment)
