...
alter table domain_event_entry
    add constraint unique_domain_event_sequence_number_for_aggregate unique (aggregate_identifier, sequence_number);

alter table domain_event_entry
    add constraint unique_domain_event_identifier unique (event_identifier);

alter table snapshot_event_entry
    add constraint unique_snapshot_event_identifier unique (event_identifier);
