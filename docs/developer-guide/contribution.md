...
and implemented it, we would be happy to add your contribution to the codebase. To do so,
...
- add documentation that describes the change
- generally comply with the Codacy report
